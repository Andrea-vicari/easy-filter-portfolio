...
function PortfolioModalJSONImage() {
           ...
           <div>
            <div className="container gray-bg p-2">
                ...
                {portJSON.map((e,i)=>{
                    return(
                        <div>
                            <div key={e.title} className={"col card" + " " + e.category + " " + "port_block"}>
                            <img className="card-img-top" src={e.image} alt="Card image"/>
...
export default PortfolioModalJSONImage